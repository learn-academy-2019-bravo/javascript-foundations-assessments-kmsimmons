...
function divByThree(num){
  if(num % 3 === 0){
    ...
    return num + ' isn\'t divisible by three'
  }
}
...
const groceryList = ['pan', 'eggs', 'jamon', 'milk', 'beer']
function firstMiddleLast(){
  for (let i = 0; i < groceryList.length; i++) {
    return groceryList[0] + ' ' + groceryList[2] + ' ' + groceryList[4]
  }
}
...
var newNums = [1, 2, 3, 4, 5]

var mult5 = newNums.map(function(index){
  return index * 5
})
